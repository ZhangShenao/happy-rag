...
class LoadingService:
    ...
    def load_pdf(self, file_path: str, method: str, strategy: str = None, chunking_strategy: str = None,
                 chunking_options: dict = None) -> str:
        """
    ...
    def _load_with_unstructured(self, file_path: str, strategy: str = "fast", chunking_strategy: str = "basic",
                                chunking_options: dict = None) -> str:
        """
    ...
    def save_document(self, filename: str, chunks: list, metadata: dict, loading_method: str, strategy: str = None,
                      chunking_strategy: str = None) -> str:
        """
        保存处理后的文档数据。
        ...
        try:
            ...
            document_data = {
                ...
                "chunking_strategy": str(
                    chunking_strategy) if loading_method == "unstructured" and chunking_strategy else None,
